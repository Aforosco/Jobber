...
{
    /// <inheritdoc />
    public partial class SeedJobsId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -11, "Develop decentralized applications.", "Singapore", "Solidity, Ethereum, Smart Contracts", "Blockchain Developer", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8190), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8190) },
                    { -10, "Manage hiring and employee relations.", "Dubai, UAE", "HR Management, Recruitment", "HR Specialist", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180) },
                    { -9, "Develop and execute marketing strategies.", "Paris, France", "SEO, Google Ads, Content Marketing", "Marketing Manager", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180) },
                    { -8, "Maintain CI/CD pipelines.", "Sydney, Australia", "AWS, Kubernetes, Docker", "DevOps Engineer", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8180) },
                    { -6, "Develop AI models and algorithms.", "Toronto, Canada", "TensorFlow, Machine Learning, Python", "AI Engineer", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170) },
                    { -5, "Manage project timelines and resources.", "Berlin, Germany", "Agile, Scrum, PMP", "Project Manager", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170) },
                    { -4, "Design user-friendly interfaces.", "Remote", "Figma, Adobe XD, HTML/CSS", "UX/UI Designer", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8170) },
                    { -3, "Protect company assets from cyber threats.", "London, UK", "Network Security, Ethical Hacking", "Cybersecurity Specialist", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8160), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8160) },
                    { -2, "Analyze data and generate reports.", "San Francisco, USA", "Python, SQL, Power BI", "Data Analyst", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8160), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8160) },
                    { -1, "Develop and maintain software applications.", "New York, USA", "C#, .NET, SQL", "Software Engineer", new DateTime(2025, 3, 22, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8150), new DateTime(2025, 2, 20, 14, 49, 42, 228, DateTimeKind.Local).AddTicks(8150) }
                });
        }
